...
void UCharacterInputHandler::SetupKeyBindings(APWPlayerController* InPWPlayerController, UInputComponent* InputComponent)
{
	...
	EnhancedInputComponent->BindAction(ExecuteAction_Main, ETriggerEvent::Triggered, this, &UCharacterInputHandler::Execute_Main);
	EnhancedInputComponent->BindAction(ExecuteAction_Sub, ETriggerEvent::Triggered, this, &UCharacterInputHandler::Execute_Sub);
...
void UCharacterInputHandler::Execute_Main(const FInputActionValue& Value)
{
	if (IsInputEnabled() == false)
	{
		return;
	...
	PWPlayerCharacter->Execute_Main();
}

void UCharacterInputHandler::Execute_Sub(const FInputActionValue& Value)
{
	if (IsInputEnabled() == false)
	{
		return;
