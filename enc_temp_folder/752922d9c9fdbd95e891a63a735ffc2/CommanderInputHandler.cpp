...
void UCommanderInputHandler::SetupKeyBindings(APWPlayerController* InPWPlayerController, UInputComponent* InputComponent)
{
	...
	EnhancedInputComponent->BindAction(SelectAction_ESC, ETriggerEvent::Triggered, this, &UCommanderInputHandler::Select_ESC);
}
...
void UCommanderInputHandler::Select_ESC(const FInputActionValue& Value)
{
	if (IsInputEnabled() == false)
	{
		return;
